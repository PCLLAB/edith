// From https://github.com/uptick/react-keyed-file-browser/pull/105
...
declare module "react-keyed-file-browser" {
  ...
  // Start personal updates
  // kinda half-assed these
  export declare const BaseFileConnectors: {
    dragSource: any;
    dragCollect: (collect: any, monitor: any) => any;
  ...
  export type FileRenderer<P = {}> = (
    props: FileRendererProps<P>
  ) => JSX.Element;
